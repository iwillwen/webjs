 ...
 *
 *      exports.serializeCookie('name', 'tj', { httpOnly: true })
 *      // => "name=tj; httpOnly"
 *
 * @param {String} name
 * @param {String} val
...
exports.serializeCookie = function (name, val, options) {
...
exports.hash = function (algorithm, str) {
...
exports.restParser = function (path, reg, reqPath) {
    var args = [];
    while (/:([\w%$-]+)/g.test(path)) {
...
exports.unserializeCookie = function (cookies) {
    if (!cookies)
        return {};
...
exports.mergeAttrs = function (a, b) {
