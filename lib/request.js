...
http.IncomingMessage.prototype.sessionStart = function () {
    var res = this.res;
    session.start(req, res);
    return this;
};
/** 关闭Session，执行后删除Session数据 */
http.IncomingMessage.prototype.sessionEnd = function () {
    var res = this.res;
    session.end(req, res);
    return this;
};
...
http.IncomingMessage.prototype.log = {
    log: function (msg) {
        ...
        this.web.logFile.write(msg + '\r\n');
        return this;
    },
    info: function (msg) {
        console.log('\x1b[33m[Info] \x1b[0m' + msg);
        this.web.logFile.write('[Info] ' + msg + '\r\n');
        return this;
    },
    err: function (msg) {
        console.log('\x1b[31m[Error] \x1b[0m' + msg);
        this.web.logFile.write('[Error] ' + msg + '\r\n');
        return this;
    },
    dbg: function (msg) {
        console.log('\x1b[34m[Debug] \x1b[0m' + msg);
        this.web.logFile.write('[Debug] ' + msg + '\r\n');
        return this;
    }
};