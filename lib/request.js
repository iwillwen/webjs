...
function Request (req) {
    ...
    req.pipe(this);
    this.__defineGetter__('url', function () { return req.url; });
    this.__defineGetter__('method', function () { return req.method; });
    this.__defineGetter__('headers', function () { return req.headers; });
    this.__defineGetter__('trailers', function () { return req.trailers; });
    this.__defineGetter__('httpVersion', function () { return req.httpVersion; });
    this.__defineGetter__('connecttion', function () { return req.connecttion; });
    this.__defineGetter__('self', function () { return req; });
}
