                ...
                switch (req.method.toLowerCase()) {
                                                ...
                                                fs.readFile(files[key].path, function (err, data) {
                                                    ...
                                                    if (i == y)
                                                        process.nextTick(function () {
                                                            router.handler('post', req, res, path, exports.server);
                                                        });
                                                });
                                            }
                                        }
                                            ...
                                            for (var key in files) {
                                                ...
                                                if (files[key].path) {
                                                    fs.readFile(files[key].path, function (err, data) {
                                                        ...
                                                        if (i == y)
                                                            process.nextTick(function () {
                                                                router.handler('put', req, res, path, exports.server);
                                                            });
                                                    });
                                                }
                                            }
                    ...
                    case "delete":
                        if (exports.server.config('readonly')) {
                            ...
                            tasks.assign("success", function () {
                                router.handler('delete', req, res, path, exports.server);
                            });
                            tasks.run();
                        }
                        break;
                    case "head":
                        if (exports.server.config('readonly')) {
                            ...
                            tasks.assign("success", function () {
                                router.handler('head', req, res, path, exports.server);
                            });
                            tasks.run();
                        }
                        break;
