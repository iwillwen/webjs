...
exports = module.exports = function static(root, options){
  ...
  global.web.set('static root', root);
...
var send = exports.send = function(req, res, next, options){
  ...
  fs.stat(path, function(err, stat){
    ...
    if (ranges) {
      ranges = utils.parseRange(len.toString(), ranges);
    ...
    res.setHeader('X-Server', 'webjs');
    // stream
    var pipes = res.listeners('pipelining');
